...
# cs4248-nlp/paper-s5-control-supervised-all-minilm-l6-v2-taco-20260402-143306
...
| Field | Value |
|-------|-------|
| Role | `control-supervised` |
| Phase | Phase 2 |
| Method | `control-supervised` |
| Dataset | `unknown` |
| Teacher | `unknown` |
...
tokenizer = AutoTokenizer.from_pretrained("cs4248-nlp/paper-s5-control-supervised-all-minilm-l6-v2-taco-20260402-143306")
model = AutoModel.from_pretrained("cs4248-nlp/paper-s5-control-supervised-all-minilm-l6-v2-taco-20260402-143306")
```
